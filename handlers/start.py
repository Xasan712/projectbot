...
from keyboards.keybords import balance_button
...
async def cmd_start(message: Message):
    ...
    if not user:
        ...
        await message.answer("You are already registered.",reply_markup=balance_button)
...
async def show_balance(message: Message):
        ...
        if user:
            ...
            await message.answer(f"Your balance: {balance} sum")
        else:
